...
co(function* () {
    var config = {'backExecRecordNum': 1, 'mysqlConfig': {'host': 'localhost', 'port': '3306', 'user': 'root', 'password': 'root', 'database': 'db_schedule'}, 'entryFile': 'index.js', 'command': 'node', 'taskRootPath': '/Users/jiang/Repo/TFSchedule/example/task', 'notifyList': '1048911681@qq.com'};
